...
export const MATRIX_SITES = [
  ...
  { name: 'Blade Ball', url: 'https://bladeball.robloxwikihub.com', icon: '⚔️', active: true },
...
export const MatrixNav = () => {
  return (
    <div className="bg-red-950/40 border-b border-red-800/30 text-xs py-2 px-4">
          ...
          {MATRIX_SITES.map((site) => (
            <a
              ...
              className={`inline-flex items-center space-x-1 transition-colors ${
                site.active
                  ? 'text-red-300 font-bold underline decoration-red-500'
